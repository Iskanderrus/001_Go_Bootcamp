...
func main() {
	...
	var days int
	if lower == "january" || lower == "march" || lower == "may" || lower == "july" ||
		lower == "august" || lower == "october" || lower == "december" {
		days = 31
	} else if lower == "april" || lower == "june" || lower == "september" || lower == "november" {
		days = 30
